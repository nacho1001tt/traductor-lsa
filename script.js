...
<head>
  ...
  <title>Traductor de Voz y Texto a Lengua de Señas</title>
...
<body>
  ...
  <header>
    <h1>Traductor de Voz y Texto a Lengua de Señas</h1>
    <button id="contrastToggle">Alto Contraste</button>
  </header>
  ...
  <main>
    <div class="controls">
      <button id="start">
        ...
        <span id="startText">Hablar</span>
      </button>
      <input type="text" id="entradaTexto" placeholder="Escribe una palabra aquí..."/>
    </div>

    <p id="texto"></p>

    <div class="video-container">
      <video id="videoSena" controls muted playsinline preload="auto" style="display:none;">
        Tu navegador no soporta la reproducción de videos.
      </video>

      <div class="video-speed">
        <label for="speedControl">Velocidad: </label>
        <input type="range" id="speedControl" min="0.5" max="1.5" step="0.25" value="0.75"/>
        <span id="speedValue">0.75x</span>
      </div>
    </div>
  </main>

  <footer>
    <p>© 2025 Proyecto Inclusión – Todos los derechos reservados</p>
  </footer>
  ...
  const video = document.getElementById("videoSena");
  ...
  addVerbConjs("Decir.mp4", ["decir","digo","dices","dice","decimos","decis","dicen","dire","diras","dira","diremos","direis","diran","decia","decias","deciamos","deciais","decian","dije","dijiste","dijo","dijimos","dijisteis","dijeron","diciendo","dicho"]);

  addVerbConjs("Contar o Narrar.mp4", ["contar","cuento","cuentas","cuenta","contamos","contais","cuentan","conte","contaste","conto","contamos","contasteis","contaron","contare","contaras","contara","contaremos","contareis","contaran","contaba","contabas","contabamos","contabais","contaban","contando","contado","narrar","narro","narras","narra","narramos","narrais","narran","narre","narraste","narro","narramos","narrasteis","narraron","narrare","narraras","narrara","narraremos","narrareis","narraran","narraba","narrabas","narrabamos","narrabais","narraban","narrando","narrado"]);

  addVerbConjs("Estar.mp4", ["estar","estoy","estas","esta","estamos","estais","estan","estuve","estuviste","estuvo","estuvimos","estuvisteis","estuvieron","estare","estaras","estara","estaremos","estareis","estaran","estaba","estabas","estabamos","estabais","estaban","estando","estado"]);

  addVerbConjs("Explicar.mp4", ["explicar","explico","explicas","explica","explicamos","explicais","explican","explique","explicaste","explico","explicamos","explicasteis","explicaron","explicare","explicaras","explicara","explicaremos","explicareis","explicaran","explicaba","explicabas","explicabamos","explicabais","explicaban","explicando","explicado"]);

  addVerbConjs("Negar.mp4", ["negar","niego","niegas","niega","negamos","negais","niegan","negue","negaste","nego","negamos","negasteis","negaron","negare","negaras","negara","negaremos","negareis","negaran","negaba","negabas","negabamos","negabais","negaban","negando","negado"]);

  addVerbConjs("apurar.mp4", ["apurar","apuro","apuras","apura","apuramos","apurais","apuran","apure","apuraste","apuro","apuramos","apurasteis","apuraron","apuraré","apuraras","apurara","apuraremos","apureis","apuran","apuraba","apurabas","apurabamos","apurabais","apuraban","apurando","apurado"].map(limpiarTexto));

  addVerbConjs("llegar.mp4", ["llegar","llego","llegas","llega","llegamos","llegais","llegan","llegue","llegaste","llego","llegamos","llegasteis","llegaron","llegare","llegaras","llegara","llegaremos","llegareis","llegaran","llegaba","llegabas","llegabamos","llegabais","llegaban","llegando","llegado"]);

  addVerbConjs("Dialogar.mp4", ["dialogar","dialogo","dialogas","dialoga","dialogamos","dialogais","dialogan","dialogue","dialogaste","dialogo","dialogamos","dialogasteis","dialogaron","dialogare","dialogaras","dialogara","dialogaremos","dialogareis","dialogaran","dialogaba","dialogabas","dialogabamos","dialogabais","dialogaban","dialogando","dialogado"]);
  ...
  function reproducirSecuencial(lista) {
    ...
    // Forzar reproducción dentro del evento de usuario y manejar bloqueos
    const playNow = () => {
      video.play().catch(err => {
        console.warn("Autoplay bloqueado, se muestran controles:", err);
        video.controls = true;
      });
    };
